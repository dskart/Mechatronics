...
#define set_Hz_C6(hz, pwm)                     OCR3A = ((2000000/(hz * 2)) * (pwm/100.00)); ICR3= 2000000/(hz * 2);
...
#define set_Hz_B7(hz, pwm)                     OCR1C = ((2000000/(hz * 2)) * (pwm/100.00)); ICR1= 2000000/(hz * 2);

#define set_timer3()            set(PORTC,6);\
                                                 set(TCCR3A,COM3A1); \
                                                 set(TCCR3B,WGM33); \
                                                 set(TCCR3B,WGM32); \
                                                 set(TCCR3A,WGM31); \
...
#define set_timer1()              set(PORTB,5);set(PORTB,6);set(PORTB,7);\
                                                 set(TCCR1A, COM1A1);\
                                                 set(TCCR1A, COM1B1);\
                                                 set(TCCR1A, COM1C1);\
                                                 set(TCCR1B,WGM13); \
